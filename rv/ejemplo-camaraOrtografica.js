...
var esfera1 = new THREE.Mesh(new THREE.SphereGeometry(5),new THREE.MeshNormalMaterial());
esfera1.position.x = 50;

var esfera2 = new THREE.Mesh(new THREE.SphereGeometry(35),new THREE.MeshNormalMaterial());
