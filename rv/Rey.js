...
Rey.merge(talloMalla.geometry,talloMalla.matrix);

Rey.merge(cubo1Malla.geometry,cubo1Malla.matrix);
Rey.merge(cubo2Malla.geometry,cubo2Malla.matrix);
Rey.merge(cubo3Malla.geometry,cubo3Malla.matrix);
Rey.merge(cubo4Malla.geometry,cubo4Malla.matrix);
Rey.merge(cubo5Malla.geometry,cubo5Malla.matrix);
Rey.merge(cubo6Malla.geometry,cubo6Malla.matrix);
